...
CALL InsertarDetalleReserva(20);
 
select*from pago ;
select * from reserva;

SELECT r.reserva_id, r.usuario_id, v.destino, r.fecha_reserva, r.numero_pasajeros, r.estado_reserva
FROM reserva r
JOIN vuelo v ON r.vuelo_id = v.vuelo_id;

SELECT r.reserva_id, u.nombres, v.destino, r.fecha_reserva, r.numero_pasajeros, r.estado_reserva
FROM reserva r
JOIN vuelo v ON r.vuelo_id = v.vuelo_id
